...
CREATE TABLE `mes_bom_detail`  (
  ...
  `Enable` int NULL DEFAULT NULL COMMENT '启用状态',
  ...
  `ModifyID` int NULL DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `mes_bom_main`  (
  ...
  `InvalidDate` datetime NOT NULL COMMENT '失效日期',
  `Enable` int NOT NULL COMMENT '启用状态',
...
CREATE TABLE `mes_defectiveproductdisposalrecord`  (
  ...
  `DisposalStartTime` datetime NULL DEFAULT NULL COMMENT '处理开始时间',
  `DisposalEndTime` datetime NULL DEFAULT NULL COMMENT '处理结束时间',
...
CREATE TABLE `mes_defectiveproductrecord`  (
  ...
  `DefectiveQuantity` int NOT NULL COMMENT '不良品数量',
...
CREATE TABLE `mes_equipmentfaultrecord`  (
  ...
  `FaultDate` datetime NULL DEFAULT NULL COMMENT '故障日期',
  ...
  `TroubleshootingStartTime` datetime NULL DEFAULT NULL COMMENT '故障排查开始时间',
  `TroubleshootingEndTime` datetime NULL DEFAULT NULL COMMENT '故障排查结束时间',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `mes_equipmentmaintenance`  (
  ...
  `EquipmentID` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备ID',
  `MaintenanceDate` datetime NULL DEFAULT NULL COMMENT '保养日期',
  ...
  `NextMaintenanceDate` datetime NULL DEFAULT NULL COMMENT '下次保养日期',
...
CREATE TABLE `mes_equipmentrepair`  (
  ...
  `EquipmentID` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备ID',
  `RepairDate` datetime NULL DEFAULT NULL COMMENT '维修日期',
...
CREATE TABLE `mes_inventorymanagement`  (
  ...
  `InventoryQuantity` int NOT NULL COMMENT '库存数量',
  ...
  `InboundDate` datetime NULL DEFAULT NULL COMMENT '入库日期',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `mes_locationmanagement`  (
  ...
  `LocationCapacity` int NOT NULL COMMENT '货位容量',
  `LocationStatus` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货位状态',
  `LocationRow` int NOT NULL COMMENT '货位行号',
  `LocationColumn` int NOT NULL COMMENT '货位列号',
  `LocationFloor` int NOT NULL COMMENT '货位层数',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `mes_process`  (
  ...
  `ProcessSequence` int NOT NULL COMMENT '工序顺序',
...
CREATE TABLE `mes_processreport`  (
  ...
  `ReportDate` datetime NOT NULL COMMENT '汇报日期',
  `CompletedQuantity` int NOT NULL COMMENT '完成数量',
  `DefectiveQuantity` int NOT NULL COMMENT '不良数量',
  ...
  `StartTime` datetime NULL DEFAULT NULL COMMENT '工序开始时间',
  `EndTime` datetime NULL DEFAULT NULL COMMENT '工序结束时间',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `mes_processroute`  (
  ...
  `RouteSequence` int NOT NULL COMMENT '路线顺序',
...
CREATE TABLE `mes_productinbound`  (
  ...
  `WarehouseID` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '仓库ID',
  `LocationID` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货位ID',
  `InboundQuantity` int NOT NULL COMMENT '入库数量',
...
CREATE TABLE `mes_productionline`  (
  ...
  `EndDate` datetime NULL DEFAULT NULL COMMENT '停用日期',
  `Remarks` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `mes_productionlinedevice`  (
  ...
  `Manufacturer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '制造商',
  `PurchaseDate` datetime NULL DEFAULT NULL COMMENT '购买日期',
  `WarrantyDate` datetime NULL DEFAULT NULL COMMENT '保修日期',
...
CREATE TABLE `mes_productionorder`  (
  ...
  `OrderQty` int NULL DEFAULT NULL COMMENT '订单数量',
...
CREATE TABLE `mes_productionplanchangerecord`  (
  ...
  `OriginalPlanQuantity` int NOT NULL COMMENT '原计划数量',
  `NewPlanQuantity` int NOT NULL COMMENT '新计划数量',
  `OriginalPlannedStartTime` datetime NULL DEFAULT NULL COMMENT '原计划开始时间',
  `NewPlannedStartTime` datetime NULL DEFAULT NULL COMMENT '新计划开始时间',
  `OriginalPlannedEndTime` datetime NULL DEFAULT NULL COMMENT '原计划结束时间',
  `NewPlannedEndTime` datetime NULL DEFAULT NULL COMMENT '新计划结束时间',
...
CREATE TABLE `mes_productionplandetail`  (
  ...
  `PlanQuantity` int NULL DEFAULT NULL COMMENT '计划数量',
  `PlannedStartTime` datetime NULL DEFAULT NULL COMMENT '计划开始时间',
  `PlannedEndTime` datetime NULL DEFAULT NULL COMMENT '计划结束时间',
...
CREATE TABLE `mes_productionreporting`  (
  ...
  `ReportingTime` datetime NULL DEFAULT NULL COMMENT '报工时间',
  `ReportHour` decimal(2, 0) NULL DEFAULT NULL COMMENT '工时(小时)',
  `Total` int NULL DEFAULT NULL COMMENT '报工数量',
  `AcceptedQuantity` int NULL DEFAULT NULL COMMENT '合格数量',
  `RejectedQuantity` int NULL DEFAULT NULL COMMENT '不合格数量',
  `AuditStatus` int NULL DEFAULT NULL COMMENT '审批状态',
...
CREATE TABLE `mes_productionreportingdetail`  (
  ...
  `ReportedQuantity` int NOT NULL COMMENT '报工数量',
  `AcceptedQuantity` int NOT NULL COMMENT '合格数量',
  `RejectedQuantity` int NOT NULL COMMENT '不合格数量',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `mes_qualityinspectionplan`  (
  ...
  `PlanEndTime` datetime NOT NULL COMMENT '计划结束时间',
...
CREATE TABLE `mes_qualityinspectionplandetail`  (
  ...
  `MaterialName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物料名称',
  `MaterialSpecification` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '物料规格',
  `QuantityToInspect` int NOT NULL COMMENT '检验数量',
...
CREATE TABLE `mes_qualityinspectionrecord`  (
  ...
  `InspectionTime` datetime NOT NULL COMMENT '检验时间',
  `InspectedQuantity` int NOT NULL COMMENT '实际检验数量',
  `PassedQuantity` int NOT NULL COMMENT '合格数量',
  `FailedQuantity` int NOT NULL COMMENT '不合格数量',
...
CREATE TABLE `mes_warehousemanagement`  (
  ...
  `WarehouseCapacity` int NOT NULL COMMENT '仓库容量',
  `CreateID` int NULL DEFAULT NULL COMMENT '创建人ID',
  `Creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `CreateDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `ModifyID` int NULL DEFAULT NULL COMMENT '修改人ID',
...
-- ----------------------------
-- Table structure for oa_examinationmanagement
-- ----------------------------
DROP TABLE IF EXISTS `oa_examinationmanagement`;
CREATE TABLE `oa_examinationmanagement`  (
...
-- ----------------------------
-- Records of oa_examinationmanagement
-- ----------------------------
INSERT INTO `oa_examinationmanagement` VALUES (1, '魏子林', '战雷', '好', 5.00, 3365);
INSERT INTO `oa_examinationmanagement` VALUES (2, '', 'test', 'test', 4.00, 3365);
INSERT INTO `oa_examinationmanagement` VALUES (4, '', '雷', 'ok', 5.00, 3365);
INSERT INTO `oa_examinationmanagement` VALUES (5, '', '测试', '测试', 4.00, 3365);

-- ----------------------------
-- Table structure for oa_personnelfile_employee_history
-- ----------------------------
DROP TABLE IF EXISTS `oa_personnelfile_employee_history`;
CREATE TABLE `oa_personnelfile_employee_history`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工职位记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of oa_personnelfile_employee_history
-- ----------------------------

-- ----------------------------
-- Table structure for oa_personnelfile_employee_info
-- ----------------------------
DROP TABLE IF EXISTS `oa_personnelfile_employee_info`;
CREATE TABLE `oa_personnelfile_employee_info`  (
  ...
  `Gender` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '性别 ENUM(\'男\',\'女\',\'其他\') DEFAULT \'其他\'',
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工基本信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of oa_personnelfile_employee_info
-- ----------------------------
INSERT INTO `oa_personnelfile_employee_info` VALUES (1, 3365, NULL, '510104200109164912', '男', '2025-09-16 00:00:00', '18328682015', 'williamwei2001@outlook.com', '13540057430', '成都', '成都', '2025-09-16 00:00:00', NULL);
INSERT INTO `oa_personnelfile_employee_info` VALUES (2, 3364, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `oa_personnelfile_employee_info` VALUES (3, 3363, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for oa_personnelfile_salary_history
-- ----------------------------
DROP TABLE IF EXISTS `oa_personnelfile_salary_history`;
CREATE TABLE `oa_personnelfile_salary_history`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工薪资记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of oa_personnelfile_salary_history
-- ----------------------------
INSERT INTO `oa_personnelfile_salary_history` VALUES (1, 3365, 3000.00, 1000.00, '2025-06-01 00:00:00', '2025-07-05 00:00:00', 3365);
INSERT INTO `oa_personnelfile_salary_history` VALUES (3, NULL, 2222.00, 2222.00, '2025-06-11 00:00:00', '2025-06-14 00:00:00', 3365);
INSERT INTO `oa_personnelfile_salary_history` VALUES (4, NULL, 6666.00, 6666.00, '2025-06-10 00:00:00', '2025-07-04 00:00:00', 3365);
INSERT INTO `oa_personnelfile_salary_history` VALUES (5, NULL, NULL, NULL, NULL, NULL, 3365);

-- ----------------------------
-- Table structure for oa_personnelfile_work_experience
-- ----------------------------
DROP TABLE IF EXISTS `oa_personnelfile_work_experience`;
CREATE TABLE `oa_personnelfile_work_experience`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工工作经历' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of oa_personnelfile_work_experience
-- ----------------------------
INSERT INTO `oa_personnelfile_work_experience` VALUES (1, NULL, '测试公司名称', 'C#', 'C#', '2025-06-07 00:00:00', '2025-07-04 00:00:00', 3365, 'C#');
...
-- ----------------------------
INSERT INTO `sys_department` VALUES ('41B96EA8-5475-4775-845D-FD66370C75AE', '成都科技有限公司2', 'H0001', NULL, NULL, NULL, '还没想好', 1, '超级管理员', '2023-05-13 09:15:56', 1, '超级管理员', '2025-06-16 18:27:47');
...
INSERT INTO `sys_department` VALUES ('8974177F-AF6B-45B5-B7AB-88F169063F40', '成都科技有限公司', 'A0001', NULL, NULL, NULL, '还没想好', 1, '超级管理员', '2023-05-13 08:56:16', 1, '超级管理员', '2025-06-16 18:27:33');
...
INSERT INTO `sys_dictionary` VALUES (107, NULL, '2025-06-16 18:17:19', 1, '超级管理员', NULL, 'SELECT User_Id as \'key\', UserTrueName as value FROM sys_user\nORDER BY CreateDate DESC;', '所有用户真实姓名', '所有用户真实姓名', 1, NULL, NULL, NULL, 0, 87, NULL);
...
INSERT INTO `sys_menu` VALUES (64, '代码生成', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 'el-icon-paperclip', NULL, 1, 9500, '代码生成', 61, '/coding', '2019-07-12 14:07:55', '超级管理员', '2025-06-16 18:18:13', '超级管理员', 0);
...
INSERT INTO `sys_menu` VALUES (303, '办公管理', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 'el-icon-s-platform', NULL, 1, 9500, '.', 0, '', '2025-06-16 18:15:12', '超级管理员', '2025-06-16 20:13:49', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (304, '员工基本信息', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导入\",\"value\":\"Import\"},{\"text\":\"导出\",\"value\":\"Export\"}]', '', NULL, 1, 11000, 'OaPersonnelFileEmployeeInfo', 305, '/OaPersonnelFileEmployeeInfo', '2025-06-16 19:12:40', '超级管理员', '2025-06-16 20:55:52', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (305, '人事档案管理', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 'el-icon-user-solid', NULL, 1, 1, '.', 303, '', '2025-06-16 19:15:00', '超级管理员', '2025-06-16 20:14:32', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (306, '员工薪资记录', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导入\",\"value\":\"Import\"},{\"text\":\"导出\",\"value\":\"Export\"}]', '', NULL, 1, 0, 'OaPersonnelFileSalaryHistory', 305, '/OaPersonnelFileSalaryHistory', '2025-06-16 19:52:57', '超级管理员', '2025-06-16 20:57:11', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (307, '员工工作经历', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导入\",\"value\":\"Import\"},{\"text\":\"导出\",\"value\":\"Export\"}]', '', NULL, 1, 0, 'OaPersonnelFileWorkExperience', 305, '/OaPersonnelFileWorkExperience', '2025-06-16 20:06:31', '超级管理员', '2025-06-16 20:57:21', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (308, '绩效管理', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 'bi-pencil-square', NULL, 1, 0, '.', 303, '', '2025-06-16 20:12:59', '超级管理员', '2025-06-16 20:14:02', '超级管理员', 0);
INSERT INTO `sys_menu` VALUES (309, '考核管理', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导入\",\"value\":\"Import\"},{\"text\":\"导出\",\"value\":\"Export\"}]', '', NULL, 1, 0, 'OaExaminationManagement', 308, '/OaExaminationManagement', '2025-06-16 20:15:23', '超级管理员', '2025-06-16 20:57:28', '超级管理员', 0);
...
INSERT INTO `sys_role` VALUES (5, '2025-06-16 18:18:57', '超级管理员', NULL, NULL, NULL, 1, NULL, NULL, NULL, 1, '企业管理员');
INSERT INTO `sys_role` VALUES (6, '2025-06-16 18:28:34', '超级管理员', NULL, NULL, NULL, 1, NULL, NULL, NULL, 5, '普通员工');
INSERT INTO `sys_role` VALUES (7, '2025-06-16 18:28:50', '超级管理员', NULL, NULL, NULL, 1, NULL, NULL, NULL, 1, '系统开发人员');
...
INSERT INTO `sys_roleauth` VALUES (100, 'Search', '2025-06-16 18:27:13', '超级管理员', 2, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (101, 'Search', '2025-06-16 18:27:13', '超级管理员', 133, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (102, '', '2025-06-16 18:27:13', '超级管理员', 247, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (103, 'Search,Add,Delete,Update,Export', '2025-06-16 18:27:13', '超级管理员', 142, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (104, 'Search', '2025-06-16 18:27:13', '超级管理员', 236, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (105, 'Search,Add,Delete,Update,Import,Export,Upload,Audit', '2025-06-16 18:27:13', '超级管理员', 9, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (106, '', '2025-06-16 18:27:13', '超级管理员', 238, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (107, 'Search,Update', '2025-06-16 18:27:13', '超级管理员', 71, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (108, '', '2025-06-16 18:27:13', '超级管理员', 260, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (109, 'Search,Add,Delete,Update,Export', '2025-06-16 18:27:13', '超级管理员', 3, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (110, '', '2025-06-16 18:27:13', '超级管理员', 281, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (111, '', '2025-06-16 18:27:13', '超级管理员', 261, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (112, 'Search,Add,Delete,Update', '2025-06-16 18:27:13', '超级管理员', 249, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (113, '', '2025-06-16 18:27:13', '超级管理员', 282, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (114, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 18:27:13', '超级管理员', 250, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (115, 'Search,Add,Delete,Update,Export', '2025-06-16 18:27:13', '超级管理员', 251, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (116, 'Search,Add,Delete,Update', '2025-06-16 18:27:13', '超级管理员', 254, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (117, 'Search,Add,Delete,Update,Print', '2025-06-16 18:27:13', '超级管理员', 253, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (118, '', '2025-06-16 18:27:13', '超级管理员', 263, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (119, '', '2025-06-16 18:27:13', '超级管理员', 262, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (120, 'Search,Add,Delete,Update,Export', '2025-06-16 18:27:13', '超级管理员', 134, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (121, 'Search,Delete', '2025-06-16 18:27:13', '超级管理员', 135, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (122, 'Search', '2025-06-16 18:27:13', '超级管理员', 136, '超级管理员', '2025-06-16 18:27:13', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (123, 'Search', '2025-06-16 18:29:04', '超级管理员', 8, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (124, 'Search', '2025-06-16 18:29:04', '超级管理员', 64, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (125, 'Search', '2025-06-16 18:29:04', '超级管理员', 2, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (126, 'Search', '2025-06-16 18:29:04', '超级管理员', 113, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (127, 'Search', '2025-06-16 18:29:04', '超级管理员', 235, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (128, 'Search', '2025-06-16 18:29:04', '超级管理员', 291, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (129, 'Search', '2025-06-16 18:29:04', '超级管理员', 62, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (130, 'Search', '2025-06-16 18:29:04', '超级管理员', 292, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (131, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 63, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (132, 'Search', '2025-06-16 18:29:04', '超级管理员', 133, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (133, 'Search', '2025-06-16 18:29:04', '超级管理员', 106, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (134, 'Search', '2025-06-16 18:29:04', '超级管理员', 247, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (135, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 142, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (136, 'Search', '2025-06-16 18:29:04', '超级管理员', 236, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (137, 'Search', '2025-06-16 18:29:04', '超级管理员', 296, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (138, 'Search,Add,Delete,Update,Import,Export,Upload,Audit', '2025-06-16 18:29:04', '超级管理员', 9, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (139, 'Search', '2025-06-16 18:29:04', '超级管理员', 237, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (140, 'Search', '2025-06-16 18:29:04', '超级管理员', 293, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (141, 'Search', '2025-06-16 18:29:04', '超级管理员', 137, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (142, 'Search', '2025-06-16 18:29:04', '超级管理员', 32, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (143, 'Search', '2025-06-16 18:29:04', '超级管理员', 132, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (144, 'Search', '2025-06-16 18:29:04', '超级管理员', 238, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (145, 'Search', '2025-06-16 18:29:04', '超级管理员', 241, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (146, 'Search', '2025-06-16 18:29:04', '超级管理员', 286, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (147, 'Search', '2025-06-16 18:29:04', '超级管理员', 239, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (148, 'Search', '2025-06-16 18:29:04', '超级管理员', 244, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (149, 'Search', '2025-06-16 18:29:04', '超级管理员', 5, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (150, 'Search', '2025-06-16 18:29:04', '超级管理员', 240, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (151, 'Search', '2025-06-16 18:29:04', '超级管理员', 242, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (152, 'Search,Update', '2025-06-16 18:29:04', '超级管理员', 71, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (153, 'Search', '2025-06-16 18:29:04', '超级管理员', 61, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (154, 'Search,Add,Delete,Update,Audit,AntiAudit,Print', '2025-06-16 18:29:04', '超级管理员', 271, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (155, 'Search,Add,Delete,Update,CopyData,Export', '2025-06-16 18:29:04', '超级管理员', 275, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (156, 'Search,Add,Delete,Update,Export,Print', '2025-06-16 18:29:04', '超级管理员', 267, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (157, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 260, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (158, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 18:29:04', '超级管理员', 255, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (159, 'Search', '2025-06-16 18:29:04', '超级管理员', 36, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (160, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 3, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (161, 'Search', '2025-06-16 18:29:04', '超级管理员', 295, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (162, 'Search', '2025-06-16 18:29:04', '超级管理员', 281, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (163, 'Search,Add,Delete', '2025-06-16 18:29:04', '超级管理员', 272, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (164, 'Search,Add,Delete,Update,CopyData,Export', '2025-06-16 18:29:04', '超级管理员', 279, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (165, 'Search,Add,Delete,Update,CopyData,Print', '2025-06-16 18:29:04', '超级管理员', 264, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (166, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 18:29:04', '超级管理员', 261, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (167, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 18:29:04', '超级管理员', 256, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (168, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 249, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (169, 'Search', '2025-06-16 18:29:04', '超级管理员', 91, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (170, 'Search', '2025-06-16 18:29:04', '超级管理员', 299, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (171, 'Search,Add,Delete,Update,Import', '2025-06-16 18:29:04', '超级管理员', 300, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (172, 'Search,Add,Delete,Update,Import', '2025-06-16 18:29:04', '超级管理员', 301, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (173, 'Search', '2025-06-16 18:29:04', '超级管理员', 298, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (174, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 282, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (175, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 265, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (176, 'Search,CopyData,Export,Print', '2025-06-16 18:29:04', '超级管理员', 257, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (177, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 18:29:04', '超级管理员', 250, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (178, 'Search', '2025-06-16 18:29:04', '超级管理员', 294, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (179, 'Search', '2025-06-16 18:29:04', '超级管理员', 297, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (180, 'Search,Export', '2025-06-16 18:29:04', '超级管理员', 273, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (181, 'Search', '2025-06-16 18:29:04', '超级管理员', 280, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (182, 'Search,Export,Print', '2025-06-16 18:29:04', '超级管理员', 266, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (183, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 270, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (184, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 258, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (185, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 251, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (186, 'Search', '2025-06-16 18:29:04', '超级管理员', 302, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (187, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 254, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (188, 'Search,Add,Delete,Update,Print', '2025-06-16 18:29:04', '超级管理员', 253, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (189, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 277, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (190, 'Search', '2025-06-16 18:29:04', '超级管理员', 289, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (191, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 18:29:04', '超级管理员', 263, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (192, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 259, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (193, 'Search,Add,Delete,Update,CopyData,Export', '2025-06-16 18:29:04', '超级管理员', 287, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (194, 'Search', '2025-06-16 18:29:04', '超级管理员', 107, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (195, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 65, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (196, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 290, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (197, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 262, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (198, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 138, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (199, 'Search,Delete,Export', '2025-06-16 18:29:04', '超级管理员', 139, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (200, 'Search,Add,Delete,Update,Export', '2025-06-16 18:29:04', '超级管理员', 134, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (201, 'Search,Delete', '2025-06-16 18:29:04', '超级管理员', 135, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (202, 'Search', '2025-06-16 18:29:04', '超级管理员', 136, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (203, 'Search', '2025-06-16 18:29:04', '超级管理员', 115, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (204, 'Search,Add,Delete,Update', '2025-06-16 18:29:04', '超级管理员', 109, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (205, 'Search,Delete,Export', '2025-06-16 18:29:04', '超级管理员', 110, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (206, 'Search,Delete,Export', '2025-06-16 18:29:04', '超级管理员', 6, '超级管理员', '2025-06-16 18:29:04', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (207, 'Search', '2025-06-16 18:32:32', '超级管理员', 235, '超级管理员', '2025-06-16 20:59:23', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (208, 'Search', '2025-06-16 18:32:42', '超级管理员', 61, '超级管理员', '2025-06-16 18:32:42', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (209, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 19:28:22', '超级管理员', 304, '超级管理员', '2025-06-16 19:28:22', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (210, 'Search', '2025-06-16 19:28:22', '超级管理员', 305, '超级管理员', '2025-06-16 19:28:22', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (211, 'Search', '2025-06-16 19:28:48', '超级管理员', 304, '超级管理员', '2025-06-16 19:28:48', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (212, 'Search', '2025-06-16 19:28:48', '超级管理员', 305, '超级管理员', '2025-06-16 19:28:48', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (213, 'Search', '2025-06-16 19:29:12', '超级管理员', 236, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (214, 'Search', '2025-06-16 19:29:12', '超级管理员', 237, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (215, 'Search', '2025-06-16 19:29:12', '超级管理员', 238, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (216, 'Search,Add,Delete,Update', '2025-06-16 19:29:12', '超级管理员', 260, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (217, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 19:29:12', '超级管理员', 255, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (218, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 19:29:12', '超级管理员', 261, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (219, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 19:29:12', '超级管理员', 256, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (220, 'Search,Add,Delete,Update', '2025-06-16 19:29:12', '超级管理员', 249, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (221, 'Search,CopyData,Export,Print', '2025-06-16 19:29:12', '超级管理员', 257, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (222, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 19:29:12', '超级管理员', 250, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (223, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:12', '超级管理员', 258, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (224, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:12', '超级管理员', 251, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (225, 'Search,Add,Delete,Update', '2025-06-16 19:29:12', '超级管理员', 254, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (226, 'Search,Add,Delete,Update,Print', '2025-06-16 19:29:12', '超级管理员', 253, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (227, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 19:29:12', '超级管理员', 263, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (228, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:12', '超级管理员', 259, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (229, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:12', '超级管理员', 262, '超级管理员', '2025-06-16 19:29:12', 6, NULL);
INSERT INTO `sys_roleauth` VALUES (230, 'Search', '2025-06-16 19:29:23', '超级管理员', 237, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (231, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 19:29:23', '超级管理员', 255, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (232, 'Search,Add,Delete,Update,CopyData,Import,Export', '2025-06-16 19:29:23', '超级管理员', 256, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (233, 'Search,CopyData,Export,Print', '2025-06-16 19:29:23', '超级管理员', 257, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (234, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:23', '超级管理员', 258, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (235, 'Search,Add,Delete,Update,Export', '2025-06-16 19:29:23', '超级管理员', 259, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (236, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:38:47', '超级管理员', 304, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (237, 'Search', '2025-06-16 20:38:47', '超级管理员', 303, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (238, 'Search', '2025-06-16 20:38:47', '超级管理员', 305, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (239, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:38:47', '超级管理员', 309, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (240, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:38:47', '超级管理员', 306, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (241, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:38:47', '超级管理员', 307, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (242, 'Search', '2025-06-16 20:38:47', '超级管理员', 308, '超级管理员', '2025-06-16 20:47:46', 5, NULL);
INSERT INTO `sys_roleauth` VALUES (243, 'Search', '2025-06-16 20:39:01', '超级管理员', 303, '超级管理员', '2025-06-16 20:39:01', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (244, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:39:01', '超级管理员', 309, '超级管理员', '2025-06-16 20:39:01', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (245, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:39:01', '超级管理员', 306, '超级管理员', '2025-06-16 20:39:01', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (246, 'Search,Add,Delete,Update,Import,Export', '2025-06-16 20:39:01', '超级管理员', 307, '超级管理员', '2025-06-16 20:39:01', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (247, 'Search', '2025-06-16 20:39:01', '超级管理员', 308, '超级管理员', '2025-06-16 20:39:01', 7, NULL);
INSERT INTO `sys_roleauth` VALUES (248, 'Search', '2025-06-16 20:39:18', '超级管理员', 309, '超级管理员', '2025-06-16 20:39:18', 6, NULL);
...
INSERT INTO `sys_tablecolumn` VALUES (1828, NULL, NULL, NULL, NULL, '员工唯一ID（主键）', 'Employee_Id', 'int', 110, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 1, 0, 1, NULL, '超级管理员', '2025-06-16 20:34:37', 1, 9950, NULL, NULL, NULL, NULL, 0, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1829, NULL, NULL, NULL, NULL, '姓名', 'User_Id', 'int', 110, NULL, '2025-06-16 18:44:56', 1, '超级管理员', '所有用户真实姓名', NULL, 1, 'select', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:34:37', 1, 9900, NULL, NULL, 1, 'select', 0, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1830, NULL, NULL, NULL, NULL, '姓名', 'Full_Name', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9850, NULL, NULL, NULL, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1831, NULL, NULL, NULL, NULL, '身份证号', 'Id_Number', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 2, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9800, NULL, NULL, 2, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1832, NULL, NULL, NULL, NULL, '性别', 'Gender', 'string', 110, NULL, '2025-06-16 18:44:56', 1, '超级管理员', '性别', NULL, 4, 'select', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9750, NULL, NULL, 4, 'select', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1833, NULL, NULL, NULL, NULL, '生日', 'Birth_Date', 'Date', 150, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 18, 'date', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:34:37', 1, 3700, NULL, NULL, 18, 'date', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1834, NULL, NULL, NULL, NULL, '手机号', 'Phone', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 9, 'phone', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9650, NULL, NULL, 9, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1835, NULL, NULL, NULL, NULL, '邮箱', 'Email', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 11, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9600, NULL, NULL, 11, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1836, NULL, NULL, NULL, NULL, '紧急联系人手机号', 'Emergency_Contact', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 13, 'phone', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9550, NULL, NULL, 13, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1837, NULL, NULL, NULL, NULL, '家庭住址', 'Address_Home', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 15, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9500, NULL, NULL, 15, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1838, NULL, NULL, NULL, NULL, '工作地址', 'Address_Work', 'string', 220, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 17, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:34:37', 1, 9450, NULL, NULL, 17, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1839, NULL, NULL, NULL, NULL, '入职日期', 'Hire_Date', 'Date', 150, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 19, 'date', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:34:37', 1, 9400, NULL, NULL, 19, 'date', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1840, NULL, NULL, NULL, NULL, '员工状态', 'Status', 'int', 110, NULL, '2025-06-16 18:44:56', 1, '超级管理员', NULL, NULL, 21, 'text', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:34:37', 1, 9350, NULL, NULL, 21, 'like', 1, 'OaPersonnelFileEmployeeInfo', 90);
INSERT INTO `sys_tablecolumn` VALUES (1841, NULL, NULL, NULL, NULL, '薪资记录ID（主键）', 'Salary_Id', 'int', 110, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 1, 0, 1, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9950, NULL, NULL, NULL, NULL, 0, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1842, NULL, NULL, NULL, NULL, '姓名', 'Employee_Id', 'int', 60, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9900, NULL, NULL, NULL, NULL, 0, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1843, NULL, NULL, NULL, NULL, '基础工资', 'Base_Salary', 'decimal', 80, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 3, 'decimal', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9850, NULL, NULL, 3, 'range', 1, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1844, NULL, NULL, NULL, NULL, '奖金', 'Bonus', 'decimal', 80, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 5, 'decimal', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9800, NULL, NULL, 5, 'range', 1, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1845, NULL, NULL, NULL, NULL, '薪资生效日期', 'Effective_Date', 'DateTime', 110, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 7, 'date', NULL, 1, 1, 4, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9750, NULL, NULL, 7, 'date', 1, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1846, NULL, NULL, NULL, NULL, '薪资结束日期', 'End_Date', 'DateTime', 110, NULL, '2025-06-16 19:46:51', 1, '超级管理员', NULL, NULL, 9, 'date', NULL, 1, 1, 4, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 9700, NULL, NULL, 9, 'date', 1, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1847, NULL, NULL, NULL, NULL, '姓名', 'User_Id', 'int', 60, NULL, '2025-06-16 19:46:51', 1, '超级管理员', '所有用户真实姓名', NULL, 1, 'select', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:06', 1, 10000, NULL, NULL, 1, 'select', 1, 'OaPersonnelFileSalaryHistory', 91);
INSERT INTO `sys_tablecolumn` VALUES (1848, NULL, NULL, NULL, NULL, '工作经历ID（主键）', 'Experience_Id', 'int', 110, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 1, 0, 1, NULL, '超级管理员', '2025-06-16 20:37:26', 1, 9950, NULL, NULL, NULL, NULL, 0, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1849, NULL, NULL, NULL, NULL, '员工ID（外键）', 'Employee_Id', 'int', 110, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:26', 1, 9900, NULL, NULL, NULL, NULL, 0, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1850, NULL, NULL, NULL, NULL, '公司名称', 'Company_Name', 'string', 150, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 13, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:37:26', 1, 9850, NULL, 13, 13, 'like', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1851, NULL, NULL, NULL, NULL, '职位', 'Position', 'string', 110, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 7, 'text', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:37:26', 1, 9994, NULL, 7, 7, 'like', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1852, NULL, NULL, NULL, NULL, '职位描述', 'Description', 'string', 220, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 9, 'textarea', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:37:26', 1, 9992, NULL, 9, 9, 'like', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1853, NULL, NULL, NULL, NULL, '开始日期', 'Start_Date', 'DateTime', 150, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 3, 'date', NULL, 1, 1, 4, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:26', 1, 9998, NULL, 3, 3, 'date', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1854, NULL, NULL, NULL, NULL, '结束日期', 'End_Date', 'DateTime', 150, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 5, 'date', NULL, 1, 1, 4, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:26', 1, 9996, NULL, 5, 5, 'date', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1855, NULL, NULL, NULL, NULL, '姓名', 'User_Id', 'int', 60, NULL, '2025-06-16 19:59:34', 1, '超级管理员', '所有用户真实姓名', NULL, 1, 'select', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:37:26', 1, 10000, NULL, 1, 1, 'select', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1856, NULL, NULL, NULL, NULL, '职位职责', 'Position_Responsibilities', 'string', 220, NULL, '2025-06-16 19:59:34', 1, '超级管理员', NULL, NULL, 11, 'textarea', NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:37:26', 1, 9990, NULL, 11, 11, 'like', 1, 'OaPersonnelFileWorkExperience', 92);
INSERT INTO `sys_tablecolumn` VALUES (1857, NULL, NULL, NULL, NULL, '', 'Id', 'int', 110, NULL, '2025-06-16 20:19:48', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 1, 0, 1, NULL, '超级管理员', '2025-06-16 20:31:51', 1, 9950, NULL, NULL, NULL, NULL, 0, 'OaExaminationManagement', 94);
INSERT INTO `sys_tablecolumn` VALUES (1858, NULL, NULL, NULL, NULL, '员工姓名', 'EmployeeName', 'string', 220, NULL, '2025-06-16 20:19:48', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:31:51', 1, 9900, NULL, NULL, NULL, NULL, 0, 'OaExaminationManagement', 94);
INSERT INTO `sys_tablecolumn` VALUES (1859, NULL, NULL, NULL, NULL, '考核内容', 'ExaminationContent', 'string', 220, NULL, '2025-06-16 20:19:48', 1, '超级管理员', NULL, 3, 3, NULL, NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:31:51', 1, 9850, NULL, 3, 3, 'like', 1, 'OaExaminationManagement', 94);
INSERT INTO `sys_tablecolumn` VALUES (1860, NULL, NULL, NULL, NULL, '考核评语', 'ExaminationComment', 'string', 220, NULL, '2025-06-16 20:19:48', 1, '超级管理员', NULL, 5, 5, NULL, NULL, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2025-06-16 20:31:51', 1, 9800, NULL, 5, 5, 'like', 1, 'OaExaminationManagement', 94);
INSERT INTO `sys_tablecolumn` VALUES (1861, NULL, NULL, NULL, NULL, '考核分数', 'ExamScore', 'decimal', 110, NULL, '2025-06-16 20:19:48', 1, '超级管理员', NULL, 7, 7, 'rate', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:31:51', 1, 9750, NULL, 7, 7, NULL, 1, 'OaExaminationManagement', 94);
INSERT INTO `sys_tablecolumn` VALUES (1862, NULL, NULL, NULL, NULL, '姓名', 'User_Id', 'int', 60, NULL, NULL, NULL, NULL, '所有用户真实姓名', 1, 1, 'select', NULL, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2025-06-16 20:31:51', 1, 10000, NULL, 1, 1, 'select', 1, 'OaExaminationManagement', 94);
...
INSERT INTO `sys_tableinfo` VALUES (8, '用户基础信息', '用户管理', 'SysDbContext', NULL, NULL, NULL, NULL, 0, NULL, 'System', 'VOL.OA', 200, 0, NULL, NULL, '用户管理', '用户管理', NULL, NULL);
...
INSERT INTO `sys_tableinfo` VALUES (89, '人事档案管理', '人事档案管理', NULL, NULL, NULL, NULL, NULL, 1, NULL, '人事档案管理', 'VOL.OA', NULL, 0, NULL, NULL, '人事档案管理', NULL, NULL, NULL);
INSERT INTO `sys_tableinfo` VALUES (90, '员工基本信息', '员工基本信息', NULL, NULL, NULL, NULL, NULL, 1, NULL, 'OaPersonnelFileEmployeeInfo', 'VOL.OA', NULL, 89, NULL, NULL, 'OaPersonnelFileEmployeeInfo', 'oa_personnelfile_employee_info', NULL, NULL);
INSERT INTO `sys_tableinfo` VALUES (91, '人员薪资记录', '人员薪资记录', NULL, NULL, NULL, NULL, NULL, 1, NULL, 'OaPersonnelFileSalaryHistory', 'VOL.OA', NULL, 89, NULL, NULL, 'OaPersonnelFileSalaryHistory', 'oa_personnelfile_salary_history', NULL, NULL);
INSERT INTO `sys_tableinfo` VALUES (92, '员工工作经历', '员工工作经历', NULL, NULL, NULL, NULL, NULL, 1, NULL, 'OaPersonnelFileWorkExperience', 'VOL.OA', NULL, 89, NULL, NULL, 'OaPersonnelFileWorkExperience', 'oa_personnelfile_work_experience', NULL, NULL);
INSERT INTO `sys_tableinfo` VALUES (93, '绩效管理', '绩效管理', NULL, NULL, NULL, NULL, NULL, 1, NULL, '绩效管理', 'VOL.OA', NULL, 0, NULL, NULL, '绩效管理', NULL, NULL, NULL);
INSERT INTO `sys_tableinfo` VALUES (94, '考核管理', '考核管理', NULL, NULL, NULL, NULL, NULL, 1, NULL, 'OaExaminationManagement', 'VOL.OA', NULL, 93, NULL, NULL, 'OaExaminationManagement', 'oa_examinationmanagement', NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 1, '无', '13888888888', '~还没想好...', NULL, 'admin', 'j79rYYvCz4vdhcboB1Ausg==', '超级管理员', NULL, 0, '283591387@qq.com', 1, 1, 'Upload/Tables/Sys_User/202305131010574561/wechat.jpg', 0, '2017-08-28 09:58:55', '2019-12-14 15:14:23', '北京市西城区', 1, '2019-08-18 00:54:06', 1, '超级管理员', 0, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIxIiwiaWF0IjoiMTc1MDA3Nzk2NiIsIm5iZiI6IjE3NTAwNzc5NjYiLCJleHAiOiIxNzUwMDg1MTY2IiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.6I_NT0p6U3f1R9M7i5iWLWhpiHwvJLLtB1QvveI06h8', NULL, '2012-06-10 11:10:03', NULL, NULL, '超级管理员', '2025-03-24 00:32:44', 1, NULL);
...
INSERT INTO `sys_user` VALUES (3363, 5, '无', NULL, NULL, NULL, 'yzj', 'Zh1J~f~MbQGdgxYUyWshRw==', '严正杰', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzYzIiwiaWF0IjoiMTc1MDA3ODA0NSIsIm5iZiI6IjE3NTAwNzgwNDUiLCJleHAiOiIxNzUwMDg1MjQ1IiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.Wbz-6iCq-PGumDao6U9FozN8EZvEpeGs6VqTUehhZuM', 1, '2025-06-16 18:24:51', '超级管理员', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (3364, 5, '无', NULL, NULL, NULL, 'yzh', '0~lE14H3dFlL_cIA0f5SRg==', '严正豪', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-06-16 18:25:43', '超级管理员', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (3365, 5, '无', NULL, NULL, NULL, 'wzl', 'Ar9_AjihicqoTlKjjHQNiA==', '魏子林', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-06-16 18:26:08', '超级管理员', NULL, NULL, NULL, NULL, NULL);
