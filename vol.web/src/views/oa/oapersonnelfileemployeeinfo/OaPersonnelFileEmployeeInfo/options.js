...
export default function(){
    ...
    const columns = [{field:'Employee_Id',title:'员工唯一ID（主键）',type:'int',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'User_Id',title:'姓名',type:'int',link:true,bind:{ key:'所有用户真实姓名',data:[]},sort:true,width:110,align:'left'},
                       ...
                       {field:'EmployeePictureUrl',title:'员工照片',type:'img',sort:true,width:110,align:'left'},
                       {field:'EmployeePosition',title:'员工岗位',type:'string',bind:{ key:'基本信息的所有岗位',data:[]},sort:true,width:120,align:'left'},
                       {field:'Phone',title:'手机号',type:'string',sort:true,width:120,align:'left'},
                       {field:'Id_Number',title:'身份证号',type:'string',sort:true,width:180,align:'left'},
                       {field:'Gender',title:'性别',type:'string',bind:{ key:'性别',data:[]},sort:true,width:80,align:'left'},
                       {field:'Email',title:'邮箱',type:'string',sort:true,width:220,align:'left'},
                       {field:'Emergency_Contact',title:'紧急联系人',type:'string',sort:true,width:120,align:'left'},
                       ...
                       {field:'Hire_Date',title:'入职日期',type:'date',sort:true,width:130,align:'left'},
                       {field:'Status',title:'员工状态',type:'int',sort:true,width:110,align:'left'},
                       {field:'Birth_Date',title:'生日',type:'date',sort:true,width:130,align:'left'}];
