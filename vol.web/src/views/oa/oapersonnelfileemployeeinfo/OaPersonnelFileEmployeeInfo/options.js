...
export default function(){
    ...
    const key = table.key;
    const editFormFields = {"User_Id":"","Id_Number":"","Gender":"","Phone":"","Email":"","Emergency_Contact":"","Address_Home":"","Address_Work":"","Birth_Date":"","Hire_Date":"","Status":""};
    const editFormOptions = [[{"dataKey":"所有用户真实姓名","data":[],"title":"姓名","field":"User_Id","type":"select"}],
                              ...
                              [{"title":"紧急联系人手机号","field":"Emergency_Contact","type":"phone"}],
    ...
    const searchFormFields = {"User_Id":"","Id_Number":"","Gender":"","Phone":"","Email":"","Emergency_Contact":"","Address_Home":"","Address_Work":"","Hire_Date":"","Status":"","Birth_Date":""};
    const searchFormOptions = [[{"dataKey":"所有用户真实姓名","data":[],"title":"姓名","field":"User_Id","type":"select"}],[{"title":"身份证号","field":"Id_Number","type":"like"}],[{"dataKey":"性别","data":[],"title":"性别","field":"Gender","type":"select"}],[{"title":"手机号","field":"Phone","type":"like"}],[{"title":"邮箱","field":"Email","type":"like"}],[{"title":"紧急联系人手机号","field":"Emergency_Contact","type":"like"}],[{"title":"家庭住址","field":"Address_Home","type":"like"}],[{"title":"工作地址","field":"Address_Work","type":"like"}],[{"title":"生日","field":"Birth_Date","type":"date"}],[{"title":"入职日期","field":"Hire_Date","type":"date"}],[{"title":"员工状态","field":"Status","type":"like"}]];
    const columns = [{field:'Employee_Id',title:'员工唯一ID（主键）',type:'int',width:110,hidden:true,readonly:true,require:true,align:'left'},
                    ...
                    //    {field:'Full_Name',title:'姓名',type:'string',sort:true,width:220,hidden:true,align:'left'},
                       ...
                       {field:'Emergency_Contact',title:'紧急联系人手机号',type:'string',sort:true,width:220,align:'left'},
                       ...
                       {field:'Hire_Date',title:'入职日期',type:'date',sort:true,width:150,align:'left'},
                       {field:'Status',title:'员工状态',type:'int',sort:true,width:110,align:'left'},
                       {field:'Birth_Date',title:'生日',type:'date',sort:true,width:150,align:'left'}];
