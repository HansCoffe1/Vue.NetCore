...
CREATE TABLE `App_News_copy1`  (
  ...
  `ViewCount` int NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 73806 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = COMPACT;
...
CREATE TABLE `ExaminationManagement`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考核管理表' ROW_FORMAT = Dynamic;
...
INSERT INTO `Sys_Menu` VALUES (146, '考核管理', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"}]', '', NULL, 1, 1, 'ExaminationManagement', 0, '/ExaminationManagement', '2024-11-13 11:18:15', '超级管理员', NULL, NULL, 0);
...
INSERT INTO `Sys_RoleAuth` VALUES (109, 'Search,Add,Delete,Update', '2024-11-13 11:44:46', '超级管理员', 146, '超级管理员', '2024-11-13 11:44:46', 1, NULL);
...
INSERT INTO `Sys_RoleAuth` VALUES (115, 'Search,Add,Delete,Update', '2024-11-13 11:48:11', '超级管理员', 146, '超级管理员', '2024-11-13 11:48:11', 6, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 969 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `Sys_TableColumn` VALUES (965, NULL, NULL, NULL, NULL, '', 'Id', 'int', 220, NULL, '2024-11-13 10:40:00', 1, '超级管理员', NULL, NULL, 0, NULL, NULL, 1, 0, NULL, 1, 0, 1, NULL, '超级管理员', '2024-11-13 11:26:33', 1, 700, NULL, NULL, NULL, NULL, 1, 'ExaminationManagement', 97);
INSERT INTO `Sys_TableColumn` VALUES (966, NULL, NULL, NULL, NULL, '员工姓名', 'EmployeeName', 'string', 220, NULL, '2024-11-13 10:40:00', 1, '超级管理员', NULL, 1, 1, 'text', 1, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2024-11-13 11:26:33', 1, 650, NULL, 1, 1, 'text', 1, 'ExaminationManagement', 97);
INSERT INTO `Sys_TableColumn` VALUES (967, NULL, NULL, NULL, NULL, '考核内容', 'ExaminationContent', 'string', 220, NULL, '2024-11-13 10:40:00', 1, '超级管理员', NULL, 1, 1, 'text', 1, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2024-11-13 11:26:33', 1, 600, NULL, 1, 1, 'text', 1, 'ExaminationManagement', 97);
INSERT INTO `Sys_TableColumn` VALUES (968, NULL, NULL, NULL, NULL, '考核评语', 'ExaminationComment', 'string', 220, NULL, '2024-11-13 10:40:00', 1, '超级管理员', NULL, 1, 1, 'text', 1, 1, 1, NULL, 0, 1, 0, 255, '超级管理员', '2024-11-13 11:26:33', 1, 550, NULL, 1, 1, 'text', 1, 'ExaminationManagement', 97);
INSERT INTO `Sys_TableColumn` VALUES (969, NULL, NULL, NULL, NULL, '考核分数', 'ExamScore', 'decimal', 120, NULL, NULL, NULL, NULL, NULL, 1, 1, 'rate', 1, 1, 1, NULL, 0, 1, 0, NULL, '超级管理员', '2024-11-13 11:26:33', 1, 0, NULL, 1, 1, 'range', 1, 'ExaminationManagement', 97);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3364 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of Sys_User
-- ----------------------------
INSERT INTO `Sys_User` VALUES (1, 1, '无', '13888888888', '~还没想好...', NULL, 'admin', 'j79rYYvCz4vdhcboB1Ausg==', '超级管理员', NULL, 0, '283591387@qq.com', 1, 1, 'Upload/Tables/Sys_User/202305132011451364/wechat.jpg', 0, '2017-08-28 09:58:55', '2019-12-14 15:14:23', '北京市西城区', 1, '2019-08-18 00:54:06', 1, '超级管理员', 0, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIxIiwiaWF0IjoiMTczMTQ3MDkwMCIsIm5iZiI6IjE3MzE0NzA5MDAiLCJleHAiOiIxNzMxNDc4MTAwIiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.Ojatu0narRi_eS_AWhQNM6kBjzyFaC2gjVy3LPkjdT8', NULL, '2012-06-10 11:10:03', NULL, NULL, '超级管理员', '2023-05-13 20:11:46', 1, NULL);
INSERT INTO `Sys_User` VALUES (3362, 2, '无', NULL, '。。', NULL, 'admin666', 'j79rYYvCz4vdhcboB1Ausg==', 'Admin测试', NULL, NULL, NULL, 1, 0, 'Upload/Tables/Sys_User/202305132011399053/wechat.jpg', 1, NULL, '2019-09-22 23:03:34', '北京市还没注册', 1, '2019-08-18 00:54:06', 1, '超级管理员', NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzYyIiwiaWF0IjoiMTczMDc2OTAzMiIsIm5iZiI6IjE3MzA3NjkwMzIiLCJleHAiOiIxNzMwNzc2MjMyIiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.ZZCHcb9EexEsTspGfYK_kwbGlov8oqwTUdsRPl1E5fg', NULL, '2019-08-13 14:24:27', NULL, '01012345678', '超级管理员', '2023-05-13 20:11:39', 1, 'e5d8e8af-3659-454c-aa8e-c201c7edbcfb,ec238385-f907-44de-b99b-0eddcffa6750');
INSERT INTO `Sys_User` VALUES (3363, 7, '无', NULL, NULL, NULL, 'wzl', 'Ar9_AjihicqoTlKjjHQNiA==', '魏子林', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzYzIiwiaWF0IjoiMTczMTQ3MDg4NiIsIm5iZiI6IjE3MzE0NzA4ODYiLCJleHAiOiIxNzMxNDc4MDg2IiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.e9iJdBlPBFfajp26U9egH1bsMVUIveOS7wjN6V3e5Dk', 1, '2024-11-13 11:37:12', '超级管理员', NULL, '超级管理员', '2024-11-13 12:08:56', 1, '41b96ea8-5475-4775-845d-fd66370c75ae');
INSERT INTO `Sys_User` VALUES (3364, 6, '无', NULL, NULL, NULL, 'yzj', 'Zh1J~f~MbQGdgxYUyWshRw==', '严正杰', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIzMzY0IiwiaWF0IjoiMTczMTQ3MDk0NiIsIm5iZiI6IjE3MzE0NzA5NDYiLCJleHAiOiIxNzMxNDc4MTQ2IiwiaXNzIjoidm9sLmNvcmUub3duZXIiLCJhdWQiOiJ2b2wuY29yZSJ9.b66JOyUJ88hGIPVK-zT_ZA8lIgV3D6Ik1ZyPkJWiwyE', 1, '2024-11-13 11:44:02', '超级管理员', NULL, NULL, NULL, NULL, '41b96ea8-5475-4775-845d-fd66370c75ae');
